...
namespace BirdWare.Test.Controllers
{
    public class FugleturObservationControllerTest
    {
        ...
        public FugleturObservationControllerTest()
        {
            ...
            fugleturObservationQueryMock.Setup(x => x.SletObservation(It.IsAny<long>()));
            fugleturQueryMock.Setup(x => x.GetSenesteFugletur()).Returns(1);
            fugleturObservationController = new FugleturObservationController(fugleturQueryMock.Object, fugleturObservationQueryMock.Object);
        }
        ...
        public void SletObservationTest()
        {
            ...
            fugleturObservationQueryMock.Verify(x => x.SletObservation(1), Times.Once);
        }
    }
}
